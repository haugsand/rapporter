export function buildParameters (routeParams, rowValue, columnValue, isSubrow, settings) {
...
export function buildParametersAll (routeParams, rowValue, columnValue, isSubrow, settings) {

    const parameters = buildParameters(routeParams, rowValue, columnValue, isSubrow, settings);

    const parametersAll = routeParams.vegobjekttype + '?' + parameters;
